...
export default function Footer() {
  ...
  return (
    <footer className="bg-surface-container-lowest border-t border-outline-variant w-full py-stack-lg px-section-padding flex flex-col items-center gap-grid-gap dark" dir="rtl">
